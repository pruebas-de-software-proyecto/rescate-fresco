...
const renderFilterControls = (props = {}) => {
    return render(_jsx(FilterControls, { ...defaultProps, ...props }));
};
describe('FilterControls', () => {
    ...
    it('debería llamar setSearchFilter cuando se escribe en el campo de búsqueda', async () => {
        ...
        render(_jsx(FilterControls, { searchFilter: "", categoryFilter: "", expiryDateFilter: "", setSearchFilter: setSearchFilter, setCategoryFilter: setCategoryFilter, setExpiryDateFilter: setExpiryDateFilter }));
